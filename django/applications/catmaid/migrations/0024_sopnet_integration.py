...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catmaid_slice', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Slice'], null=True)),
        ))
        db.send_create_signal('catmaid', ['Slice'])

        # Adding model 'BlockInfo'
        db.create_table('catmaid_blockinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Project'])),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal('catmaid', ['BlockInfo'])

        # Adding model 'Segment'
        db.create_table('catmaid_segment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Project'])),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ...
            ('slice_a', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slice_a', to=orm['catmaid.Slice'])),
            ('slice_b', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slice_b', null=True, to=orm['catmaid.Slice'])),
            ('slice_c', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slice_c', null=True, to=orm['catmaid.Slice'])),
        ))
        db.send_create_signal('catmaid', ['Segment'])

        # Adding model 'Block'
        db.create_table('catmaid_block', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Project'])),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal('catmaid', ['Block'])


    def backwards(self, orm):
        # Deleting model 'Slice'
        db.delete_table('catmaid_slice')

        # Deleting model 'BlockInfo'
        db.delete_table('catmaid_blockinfo')

        # Deleting model 'Segment'
        db.delete_table('catmaid_segment')

        # Deleting model 'Block'
        db.delete_table('catmaid_block')
    ...
    models = {
        ...
        'catmaid.segment': {
            ...
            'slice_a': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slice_a'", 'to': "orm['catmaid.Slice']"}),
            'slice_b': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slice_b'", 'null': 'True', 'to': "orm['catmaid.Slice']"}),
            'slice_c': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slice_c'", 'null': 'True', 'to': "orm['catmaid.Slice']"}),
            'stack': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.Stack']"}),
        ...
        'catmaid.slice': {
            ...
            'min_x': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'min_y': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.Slice']", 'null': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catmaid.Project']"}),
